class GoodsHome {
  ...
  GoodsHome({this.code, this.message, this.data});

  GoodsHome.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    message = json['message'];
    data = json['data'] != null ? new GoodsHomeData.fromJson(json['data']) : null;
  }
...
class GoodsHomeData {
  ...
  GoodsHomeData.fromJson(Map<String, dynamic> json) {
    if (json['slides'] != null) {
